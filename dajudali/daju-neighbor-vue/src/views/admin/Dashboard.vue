...
.sidebar-header .logo { color: #FF7B2C; font-size: 16px; font-weight: 800; }
.sidebar-header .logo-short { color: #FF7B2C; font-size: 16px; font-weight: 800; display: block; }

.sidebar-nav { flex: 1; padding: 8px; display: flex; flex-direction: column; gap: 2px; }
.nav-item {
  display: flex; align-items: center; gap: 12px;
  padding: 12px 14px; border-radius: 10px;
  color: #a0a7b8; text-decoration: none; font-size: 14px;
  transition: all 0.2s; white-space: nowrap; cursor: pointer;
}
.nav-item:hover { background: rgba(255,255,255,0.06); color: #e0e0e0; }
.nav-item.active { background: rgba(255,123,44,0.2); color: #FF7B2C; font-weight: 600; }
.nav-icon { flex-shrink: 0; }
.nav-label { overflow: hidden; }

.sidebar-footer { padding: 12px; }
.collapse-btn { width: 36px; height: 36px; background: rgba(255,255,255,0.06); border: none; color: #a0a7b8; border-radius: 8px; cursor: pointer; display: flex; align-items: center; justify-content: center; margin: 0 auto; }

/* ====== 右侧内容区 ====== */
.main-area { flex: 1; display: flex; flex-direction: column; background: #fff; transition: margin-left 0.25s; min-height: 100vh; }
.top-bar {
...
.top-title { font-size: 16px; font-weight: 700; color: #333; }
