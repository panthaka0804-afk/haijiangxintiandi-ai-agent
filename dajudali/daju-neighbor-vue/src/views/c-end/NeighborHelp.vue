...
.nh-hero-btn {
  ...
  background: rgba(255,255,255,.92); color: #8A5E12; font-weight: 700; font-size: 13px;
...
.nh-btn-primary { background: #fff; color: #1A1A1A; }
.nh-btn-ghost { background: rgba(0,0,0,.25); color: #fff; border: 1px solid rgba(255,255,255,.4); }
