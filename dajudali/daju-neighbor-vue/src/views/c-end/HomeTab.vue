...
.qlink-icon { width: 58px; height: 58px; border-radius: 16px; border: 1px solid rgba(255,255,255,0.10); background: linear-gradient(145deg, #2d2d31, #1f1f23); box-shadow: 6px 6px 14px rgba(0,0,0,0.55), -5px -5px 12px rgba(255,255,255,0.04), inset 0 1px 0 rgba(255,255,255,0.12); display: flex; align-items: center; justify-content: center; color: #fff; transition: all 0.2s; }
.qlink-icon svg { filter: drop-shadow(0 -1px 1px rgba(0,0,0,0.6)) drop-shadow(0 1px 1px rgba(255,255,255,0.25)); }
.qlink-icon.active { color: #fff; background: linear-gradient(145deg, #3a3a3f, #26262a); border-color: rgba(255,255,255,0.22); }
