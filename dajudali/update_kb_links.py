...
'海江新天地各项活动可通过小程序报名：点这里 → <a href="#小程序://海江新天地">打开报名页面</a>

如无法打开，请微信搜索"海江新天地"小程序，或前往1层服务台现场报名。'
WHERE question LIKE '%活动报名%' AND tenant_id=1
""")

conn.execute("""
UPDATE knowledge_base SET answer =
'海江夜校可通过小程序报名：点这里 → <a href="#小程序://海江新天地">打开课程报名</a>

选择想参加的课程即可。也可微信搜索"海江新天地"小程序，或至1层服务台咨询。'
